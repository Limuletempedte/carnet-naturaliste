...
export const TAXON_LOGOS: Record<TaxonomicGroup, string> = {
    ...
    [TaxonomicGroup.SCORPION]: '/Logo/Scorpions.png',
    [TaxonomicGroup.FISH]: '/Logo/Poissons.png',
    [TaxonomicGroup.CRUSTACEAN]: '/Logo/Crustacés.png',
    [TaxonomicGroup.BRANCHIOPOD]: '/Logo/Branchiopodes.png',
    [TaxonomicGroup.GASTROPOD]: '/Logo/Gastéropodes.png',
    [TaxonomicGroup.BIVALVE]: '/Logo/Bivalves.png',
    [TaxonomicGroup.CHIROPTERA]: '/Logo/Chiroptères.png',
    [TaxonomicGroup.DERMAPTERA]: '/Logo/Dermatères.png',
